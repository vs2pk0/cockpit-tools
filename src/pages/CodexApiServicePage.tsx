...
import { readCodexPlanBadgeStylePreferences } from "../components/codex/CodexPlanBadge";
...
export function CodexApiServicePage() {
  ...
  const [planBadgeStylePreferences] = useState(() =>
  ...
  const exampleModelId = displayModelIds[0] ?? "gpt-5.5";
  const exampleApiKey = displayApiKey || "<api-key>";
        ...
        <section className="codex-api-service-hero">
          ...
          <div className="codex-api-service-hero-actions">
            ...
            <button
              ...
              disabled={!collection || busy || testDialogRunning || cpaServiceBusy}
            >
              <Power size={14} />
              {isCpaCredentialMode
                ? cpaServiceRunning
                ...
                {isCpaCredentialMode && (
                  <div className="codex-api-service-head-actions">
                    ...
                    <button
                      ...
                      disabled={busy || testDialogRunning || cpaServiceLoading}
                    >
                      <Server size={14} />
